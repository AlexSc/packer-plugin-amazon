...
type FlatConfig struct {
	...
	EmitStubArtifact                          *bool                                  `mapstructure:"emit_stub_artifact" required:"false" cty:"emit_stub_artifact" hcl:"emit_stub_artifact"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"emit_stub_artifact":                    &hcldec.AttrSpec{Name: "emit_stub_artifact", Type: cty.Bool, Required: false},
