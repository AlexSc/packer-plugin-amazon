...
type FlatDatasourceOutput struct {
	...
	RootDeviceSnapshotId *string           `mapstructure:"root_device_snapshot_id" cty:"root_device_snapshot_id" hcl:"root_device_snapshot_id"`
...
func (*FlatDatasourceOutput) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"root_device_snapshot_id": &hcldec.AttrSpec{Name: "root_device_snapshot_id", Type: cty.String, Required: false},
